...
// 1. TENTUKAN BASE URL DINAMIS
// Membaca dari environment variable, jika tidak ada fallback ke localhost:8000
...
// 2. REQUEST INTERCEPTOR: Paksa tempel Token di Header
...
// 3. RESPONSE INTERCEPTOR: Handle Token Mati (401)
  ...
  async (error) => {
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
      ...
      try {
        ...
        // Panggil endpoint refresh token menggunakan BASE URL DINAMIS
        // Menggunakan axios biasa (bukan instance axiosClient) untuk menghindari loop interceptor
